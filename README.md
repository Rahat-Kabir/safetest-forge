...
Report output is designed to be useful in both terminals and automation:
`--cases` lists the individual pytest outcomes when available, while
`--coverage` shows the normalized line coverage summary generated by
`pytest-cov`.
